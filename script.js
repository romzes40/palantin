const CSV_URL = 'https://docs.google.com/spreadsheets/d/17BKt5cNhkIKReRvZzwG3JoiDzGH7zdYqCE3kqvUKBNM/edit?usp=sharing' + Date.now(); // Замени на публичную ссылку, если нужно
let products = [];
let cart = [];
